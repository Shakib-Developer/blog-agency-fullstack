    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative container ">
        ...
        <div className="grid grid-cols-12 gap-[30px]">
          {
            data.map((item, index)=><div key={index} className="col-span-12 xl:col-span-4 px-4 mb-8">
            <Link className="block max-w-md mx-auto group relative shadow-lg" href={`/blog-details/${item?.id}`}>
